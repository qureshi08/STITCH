...
import {
    Layers, Package, DollarSign, Calendar, ArrowRight,
    Loader2, TrendingUp, Inbox, MessageSquare, Plus, Clock, CheckCircle2
} from 'lucide-react';
    ...
    useEffect(() => {
        async function load() {
            ...
            try {
                ...
                setStats(s);
                const collections = await getCollections(user.organization_id, user.role, user.id);
