...
import { ClientCollectionDetailClient } from '@/components/ClientCollectionDetailClient';
import { redirect } from 'next/navigation';
import { AlertCircle } from 'lucide-react';
import Link from 'next/link';

export default async function ClientCollectionDetailPage({
    params,
    searchParams
}: {
